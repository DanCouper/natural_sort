defmodule NaturalSortTest do
  ...
  test "should sort strings of numbers in maps" do
    unsorted = [
      %{sortable: "1-20"},
      %{sortable: "1-2"},
      %{sortable: "10-20"},
    ...
    assert NaturalSort.sort_by(unsorted, fn x -> x.sortable end) == sorted
  end
  ...
  test "should pass further sorting tests 4 from https://github.com/versioneye/naturalsorter" do
    assert NaturalSort.sort(["1.5.2", "1.4.4", "1.5.2-patch"]) == [
             "1.4.4",
             "1.5.2",
             "1.5.2-patch"
           ]
  ...
  test "should pass further sorting tests 7 from https://github.com/versioneye/naturalsorter" do
    assert NaturalSort.sort(["1.5.2-patch", "1.5.2", "1.4.4"]) == [
             "1.4.4",
             "1.5.2",
             "1.5.2-patch"
           ]
